...
{
    public class TSEMembershipProvider : MembershipProvider
    {
        #region Not Used
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            {
                return new MembershipUser("TSEMembershipProvider", username, UserManager.User.KullaniciUN, UserManager.User.Username, null, null, true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            }
            else
            {
                return null;
